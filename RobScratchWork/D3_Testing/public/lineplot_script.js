...
const lineplot_margin = {top: 10, right: 30, bottom: 30, left: 60},
    width = 460 - lineplot_margin.left - lineplot_margin.right,
    height = 400 - lineplot_margin.top - lineplot_margin.bottom;

// append the svg object to the body of the page
const svg = d3.select("#my_dataviz")
  .append("svg")
    .attr("width", width + lineplot_margin.left + lineplot_margin.right)
    .attr("height", height + lineplot_margin.top + lineplot_margin.bottom)
  .append("g")
    .attr("transform", `translate(${lineplot_margin.left},${lineplot_margin.top})`);
